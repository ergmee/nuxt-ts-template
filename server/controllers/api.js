...
router.post('/createProduct', jsonParser, (req, res) => {
...
router.post('/removeProduct', jsonParser, (req, res) => {
...
router.post('/saveRecept', jsonParser, (req, res) => {
